    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calcu_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                f_amount= Integer.parseInt(amount_edt.getText().toString());
                f_inter= Integer.parseInt(inter_edt.getText().toString());
                f_year= Integer.parseInt(year_edt.getText().toString());
                f_month= Integer.parseInt(month_edt.getText().toString());
                // convert to intrest
